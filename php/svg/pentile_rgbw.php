...
$gridTable = [
    [
        ["grad" => "rgrad", "scale" => [0.5, 0.5], "ratio" => [0.4, 0.4],
         "round" =>[0.1, 0.1] ],
        ["grad" => "bgrad", "scale" => [0.5, 0.5], "ratio" => [0.4, 0.4],
        "round" =>[0.1, 0.1] ],
    ],
    [
        ["grad" => "ggrad", "scale" => [0.5, 0.5], "ratio" => [0.4, 0.4],
         "round" =>[0.1, 0.1] ],
        ["grad" => "wgrad", "scale" => [0.5, 0.5], "ratio" => [0.4, 0.4],
         "round" =>[0.1, 0.1] ],
    ],
];
