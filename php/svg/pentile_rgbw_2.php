...
$gridTable = [
    [
        ["grad" => "rgrad", "scale" => [0.5, 1.0], "ratio" => [0.2, 0.7],
         "round" =>[0.2, 0.1] ],
        ["grad" => "bgrad", "scale" => [0.5, 1.0], "ratio" => [0.2, 0.7],
        "round" =>[0.2, 0.1] ],
    ],
    [
        ["grad" => "ggrad", "scale" => [0.5, 1.0], "ratio" => [0.2, 0.7],
         "round" =>[0.2, 0.1] ],
        ["grad" => "wgrad", "scale" => [0.5, 1.0], "ratio" => [0.2, 0.7],
         "round" =>[0.2, 0.1] ],
    ],
];
